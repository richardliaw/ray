...
def eval_image(image,
  ...
  """
    ...
    with tf.name_scope('eval_image'):
        ...
        # Compute resize_height and resize_width to be the
        # minimum values such that
...
class InputPreprocessor(object):
    ...
    def build_prefetch_input_processing(
            self, batch_size, model_input_shapes, num_splits, cpu_device,
            params, gpu_devices, model_input_data_types, dataset):
        ...
        with tf.device(cpu_device):
            ...
            remote_fn, args = self.minibatch_fn(
                ...
                datasets_repeat_cached_sample=params.
                datasets_repeat_cached_sample,
    ...
    def minibatch_fn(self, batch_size, model_input_shapes, num_splits, dataset,
                     subset, train, datasets_repeat_cached_sample, num_threads,
        ...
        with tf.name_scope('batch_processing'):
            ds = self.create_dataset(
                batch_size, num_splits, batch_size_per_split, dataset, subset,
                train, datasets_repeat_cached_sample, num_threads,
                datasets_use_caching,
                datasets_parallel_interleave_cycle_length,
                datasets_sloppy_parallel_interleave)
